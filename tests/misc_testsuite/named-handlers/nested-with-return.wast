...
(module
  (type $ht (handler (result i32)))
	...
	(type $ft_client (func (param (ref $ht) (ref $ht)) (result i32)))
	(type $ct_client (cont $ft_client))

	(type $ft_inner (func (param (ref $ct_client) (ref $ht)) (result i32)))
	(type $ct_inner (cont $ft_inner))

	(type $ft_client_ask (func (param i32) (param (ref $ht)) (result i32)))
	(type $ct_client_ask (cont $ft_client_ask))

  ;; Control tag 
  (tag $ask (result i32))

  (func $client (param $hname_inner (ref $ht)) (param $hname_outer (ref $ht)) (result i32)
    (local $a i32)
  ...
  (func $environ-outer (param $k (ref $ct_inner)) (param $k_client (ref $ct_client)) (result i32)
  ...
  (func $environ-inner (param $k (ref $ct_client)) (param $houter (ref $ht)) (result i32)
    (local $k_ask (ref $ct_client_ask))
    (block $on_ask (result (ref $ct_client_ask)) 
